...
class PythonContextHandler : ContextHandler {
	public:
		PyObject_HEAD
};

static void PythonContextHandler_dealloc(PythonContextHandler * self) {
  delete self;
}

static PyObject *PythonContextHandler_new(PyTypeObject *type, PyObject *args, PyObject *kwds) {
  /* OBVIOUSLY NEED EXTRA TEST AND CAUTION ON INITIALIZATION */
  return (PyObject *) new PythonContextHandler();
}
